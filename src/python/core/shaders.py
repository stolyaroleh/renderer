...
vertex_shaded = \
    ...
    void main() {
        ...
        pos_world_space = (M * vec4(vertex_pos, 1)).xyz;
        ...
        vec3 light_pos_camera_space = (V * vec4(light_pos_world, 1.0)).xyz;
...
fragment_shaded = \
    ...
    void main() {
        ...
        float distance = length( LightPosition_worldspace - pos_world_space );
