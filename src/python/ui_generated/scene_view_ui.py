...
class Ui_SceneViewWidget(object):
    def setupUi(self, SceneViewWidget):
        ...
        self.filename = QtWidgets.QLineEdit(self.Meshes)
        self.filename.setObjectName("filename")
        self.gridLayout_3.addWidget(self.filename, 2, 1, 1, 1)
        self.render_btn = QtWidgets.QPushButton(self.Meshes)
        self.render_btn.setObjectName("render_btn")
        self.gridLayout_3.addWidget(self.render_btn, 3, 1, 1, 1)
        self.label = QtWidgets.QLabel(self.Meshes)
        ...
        self.intensity.setProperty("value", 30.0)
