...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scene_view = QtWidgets.QOpenGLWidget(self.centralwidget)
        self.scene_view.setObjectName("scene_view")
        self.gridLayout.addWidget(self.scene_view, 0, 0, 1, 1)
        self.render_view = QtWidgets.QOpenGLWidget(self.centralwidget)
        self.render_view.setObjectName("render_view")
        self.gridLayout.addWidget(self.render_view, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_scene_view.setShortcut(_translate("MainWindow", "1"))
        self.action_render_view.setText(_translate("MainWindow", "Render View"))
        self.action_render_view.setShortcut(_translate("MainWindow", "2"))
